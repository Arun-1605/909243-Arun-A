namespace mStockAPI.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<mStockAPI.Models.mStockContext>
    {
        ...
        {
            var jojo = new AppUser { Email = "jojo@gmail.com", Password = "Jojo@123", UserType = UserType.User };
            var admin = new AppUser { Email = "admin@gmail.com", Password = "Admin@123", UserType = UserType.Admin };
            ...
            context.Users.AddOrUpdate(u => u.Email, jojo, admin);
